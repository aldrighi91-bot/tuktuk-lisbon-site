...
function buildCustomerConfirmation(payload, contactEmail = DEFAULT_CONTACT_EMAIL) {
  ...
  const text = [
    ...
    '',
    'This is not a booking confirmation yet. Our team is checking availability, pricing, and the details you requested, and we will reply as soon as possible.',
    '',
  ...
  const html = [
    ...
    '<p>This is not a booking confirmation yet. Our team is checking availability, pricing, and the details you requested, and we will reply as soon as possible.</p>',
